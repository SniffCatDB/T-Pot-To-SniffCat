exports.MAIN = {
	/* --------------------------- Server --------------------------- */
	SERVER_ID: null, // Server identifier (e.g., 'pl-waw-honeypot', 'home-honeypot', 'isp-orange-de'). Use 'development' for testing only. 'production' has no effect. Use null to leave it unset.
	...
	IP_REPORT_COOLDOWN: 6 * 60 * 60 * 1000, // Minimum time between reports of the same IP. Must be >= 20 minutes. Do not set too low values, as it would waste API quota due to daily rate limits.
